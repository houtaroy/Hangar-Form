 ...
 * @LastEditTime: 2021-07-13 12:07:37
 -->
<template>
...
export default {
  ...
  methods: {
    ...
    handleDownMerge() {
      ...
      // 获取下一列单元格的rowspan
      const nextRowSpan = this.rightMenuSelectValue.trs[this.trIndex + currentRowspan].tds[
        this.tdIndex
      ].rowspan;
    ...
    handleRightMerge() {
      ...
      if (
        sumCols - this.rightMenuSelectValue.trs[this.trIndex].tds[this.tdIndex].colspan <=
        this.tdIndex
      ) {
